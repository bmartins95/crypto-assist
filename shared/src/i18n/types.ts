...
export interface UIText {
  ...
  profit_assetsList_sortAlphabetical: string;
  profit_assetsList_sortMovement: string;
  profit_assetsList_sortAllocation: string;
  profit_assetsList_colAsset: string;
  profit_assetsList_colPeriod: string;
  profit_assetsList_colPrice: string;
  profit_assetsList_colChange: string;
  profit_assetsList_emptySearch: string;
  profit_tooltip_realized: string;
  profit_tooltip_opsCount: string;
