...
const frFR: UIText = {
  ...
  history_form_trade: 'Échange entre actifs',
  ...
  trade_form_title: 'Échange entre actifs',
  trade_form_from: 'De (vendre)',
  trade_form_to: 'Vers (acheter)',
  trade_form_qty: 'Qté vendue',
  trade_form_price: 'Total',
  trade_form_fee: 'Frais',
  trade_form_save: 'Enregistrer',
  trade_form_cancel: 'Annuler',
